    ...
    if (container) {
        ...
        elements.forEach(element => {
            ...
            if (element.tagName.toLowerCase() === 'p' && element.textContent.includes('_filterable_list_')) {
                    ...
                    rows.forEach((row, rowIndex) => {
                        if (rowIndex > 0) { 
                            ...
                            cells.forEach(cell => {
                                ...
                                td.textContent = cell.textContent.trim(); // Ensure trimmed content
                ...
                let url = `/remuneration-compensation/procedures/json/${nameWithoutExtension}-${language}.json`;
                if (Nfilterable > 1) {
                ...
                Nfilterable++; // Increment Nfilterable after use
